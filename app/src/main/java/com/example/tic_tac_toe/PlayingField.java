...
public class PlayingField extends AppCompatActivity {
    ...
    private void performAction(ImageView imageView, int selectedBoxPosition){
        ...
        if(activePlayer == 1){
            ...
            if(checkResult()){
                ResultDialog resultDialog = new ResultDialog(PlayingField.this,
                        playerOneName.getText().toString()+" is a Winner",
                        PlayingField.this);
            ...
            if(checkResult()){
                ResultDialog resultDialog = new ResultDialog(PlayingField.this,
                        playerTwoName.getText().toString()+" is a Winner",
                        PlayingField.this);
                resultDialog.setCancelable(false);
                resultDialog.show();
                currentScoreTwo++;
    ...
    private boolean checkResult(){
        ...
        for (int i = 0; i<combinationList.size(); i++){
            ...
            if(boxPositions[combination[0]] == activePlayer &&
                    boxPositions[combination[1]] == activePlayer &&
                    boxPositions[combination[2]] == activePlayer){
                response = true;
            }
        }
        return response;
    ...
    private boolean isBoxSelecteble(int boxPosition){
        boolean response = false;
